...
} from "./search/person-detail/templates/person-attribute-template/person-attribute-template.component";
import {
  PersonAttributeAdvancedTemplateComponent
} from "./search/person-detail/templates/person-attribute-advanced-template/person-attribute-advanced-template.component";
import {
  PersonAttributeEVotingTemplateComponent
} from "./search/person-detail/templates/person-attribute-evoting-template/person-attribute-evoting-template.component";
import {
  PersonAttributeValidationTemplateComponent
} from "./search/person-detail/templates/person-attribute-validation-template/person-attribute-validation-template.component";
...
} from "./shared/components/data-import-status-icon/data-import-status-icon.component";
...
} from "./shared/components/filtered-person-table/filtered-person-table.component";
